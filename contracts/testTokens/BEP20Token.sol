...
contract BEP20Token is Context, IBEP20, Ownable {
    ...
    modifier onlyMinter() {
        require(Minter[msg.sender] == true || msg.sender == owner(), 'Only owner or minter');
        _;
    }
    /**
    ...
    function setMinter(address _minter, bool _status) public override onlyOwner {
     ...
     */
    function mint(address _client, uint256 amount) public override onlyMinter returns (bool) {
